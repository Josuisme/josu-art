...
const desings = () => {
  return (
    <div>
      ...
      <p className="font-semibold text-justify text-2xl m-5 p-5 h-auto w-auto bg-amber-100 text-gray-800 border-4 border-rose-600 rounded-3xl content-center bg-gradient-to-t from-amber-200 via-amber-200 flex-1">
        ...
        real. Y que en muchas ocasiones obtener estos objetos seria imposible.
