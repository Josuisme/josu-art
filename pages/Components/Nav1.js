            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="flex items-center px-2 lg:px-0">
                <a className="flex-shrink-0" href="#">
                  <Image className="block lg:hidden" src="" width="16" height="12" alt="Logo" />
                  <Image className="hidden lg:block h-12 w-auto" src="" width="auto" height="12" alt="Logo" />
                </a>
                <div className="hidden lg:block lg:ml-2">
                  <div className="flex">
                    <a href="#" className="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-weight hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Location </a>
                    <a href="#" className="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-weight hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Article </a>
                    <a href="#" className="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-weight hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Recipe </a>
                    <a href="#" className="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-weight hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Promo </a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex lg:hidden">
                <button click="menu=!menu" className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out" aria-label="Main menu" aria-expanded="false">
